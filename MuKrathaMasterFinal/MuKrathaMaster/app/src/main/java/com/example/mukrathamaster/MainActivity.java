...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateTimerText() {
        ...
        tvTimer.setText(getString(R.string.time_label) + seconds);
        // *****************************************************************
    ...
    private void showSummaryDialog() {
        ...
        // ******************* แก้ไข: ใช้ String Resource *******************
        tvTotal.setText(getString(R.string.summary_total_grilled, totalGrilled));
        tvFinal.setText(getString(R.string.summary_final_score, score));
        tvHigh.setText(getString(R.string.high_score_label) + highScore);
        tvHappy.setText(getString(R.string.summary_happiness, happiness));
        tvBurnt.setText(getString(R.string.summary_burnt_count, burntCount));
        // *****************************************************************
